...
public class ListGroup {
    private class Node {
        ...
        public ListInfo getInfoHead() {
            return infoHead;
        }

        public void setInfoHead(ListInfo infoHead) {
        ...
        public Node(String name, ListStudent studHead, ListInfo infoHead) {
            this.infoHead = infoHead;
            this.studHead = studHead;
            this.name = name;
        }
    ...
    public void add(String name, ListStudent studHead, ListInfo infoHead) {
